...
const TRANSLATIONS = {
    ...
    hero_title:       { en: 'Will your apps work without Google Play Services?', fr: 'Est-ce que vos apps fonctionnent sans Google Play Services ?', de: 'Funktionieren deine Apps ohne Google Play Services?', it: 'Le tue app funzionano senza Google Play Services?', es: '¿Funcionan tus apps sin Google Play Services?' },
    hero_subtitle:    { en: 'Community-tested compatibility for deGoogled Android, with or without microG.', fr: 'Compatibilité testée par la communauté pour Android dégooglisé, avec ou sans microG.', de: 'Von der Community getestete Kompatibilität für entgoogeltes Android, mit oder ohne microG.', it: 'Compatibilità testata dalla community per Android deGooglizzato, con o senza microG.', es: 'Compatibilidad probada por la comunidad para Android desgooglizado, con o sin microG.' },
    ...
    about_p1:         { en: 'Sapio is an anagram of Open Source API. Sapio tells you whether an Android app works on a device without Google Play Services, that is, a deGoogled bare AOSP device, coupled or not with microG.', fr: 'Sapio est l\'anagramme d\'Open Source API. Sapio indique si une application Android fonctionne sur un appareil sans Google Play Services, c\'est-à-dire un appareil AOSP dégooglisé, associé ou non à microG.', de: 'Sapio ist das Anagramm von Open Source API. Sapio zeigt, ob eine Android-App auf einem Gerät ohne Google Play Services funktioniert, also auf einem entgoogelten Bare-AOSP-Gerät, mit oder ohne microG.', it: 'Sapio è l\'anagramma di Open Source API. Sapio indica se un\'applicazione Android funziona su un dispositivo senza Google Play Services, cioè un dispositivo AOSP deGooglizzato, con o senza microG.', es: 'Sapio es el anagrama de Open Source API. Sapio indica si una aplicación Android funciona en un dispositivo sin Google Play Services, es decir, un dispositivo AOSP desgooglizado, con o sin microG.' },
    about_p2:         { en: 'Sapio\'s evaluations are made by the community, for the community. Sapio can serve as a lobbying tool: by sharing compatibility on social media, you raise awareness among app developers about respecting users\' personal data.', fr: 'Les évaluations de Sapio sont faites par la communauté, pour la communauté. Sapio peut servir de moyen de pression : en partageant la compatibilité sur les réseaux sociaux, vous sensibilisez les développeurs au respect des données personnelles.', de: 'Die Bewertungen in Sapio stammen von der Community, für die Community. Sapio kann als Druckmittel dienen: Wenn du die Kompatibilität in sozialen Medien teilst, sensibilisierst du App-Entwickler für den Schutz persönlicher Daten.', it: 'Le valutazioni di Sapio sono fatte dalla community, per la community. Sapio può fungere da strumento di pressione: condividendo la compatibilità sui social, sensibilizzi gli sviluppatori sul rispetto dei dati personali.', es: 'Las evaluaciones de Sapio las hace la comunidad, para la comunidad. Sapio puede servir como herramienta de presión: al compartir la compatibilidad en redes sociales, conciencias a los desarrolladores sobre el respeto a los datos personales.' },
    about_star:       { en: 'GitHub', fr: 'GitHub', de: 'GitHub', it: 'GitHub', es: 'GitHub' },
