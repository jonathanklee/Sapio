...
const TRANSLATIONS = {
    ...
    hero_title:       { en: 'Will your apps work without Google Play Services?', fr: 'Vos apps fonctionnent-elles sans Google Play Services ?', de: 'Funktionieren deine Apps ohne Google Play Services?', it: 'Le tue app funzionano senza Google Play Services?', es: '¿Funcionan tus apps sin Google Play Services?' },
